...
cd third_party/librealsense/ # current dir: <PROJECTROOT>/third_party/librealsense
...
mkdir -p build && cd build # current dir: <PROJECTROOT>/third_party/librealsense/build
